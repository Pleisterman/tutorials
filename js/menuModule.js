...
( function( app ){
    ...
    app.menuModule = function( ) {
        ...
        self.titleOptions = {                                           // named array 
            ...
            'top'                   :   '62px',                         // css
            'styleWidth'            :   '100%',                         // css
            'text'                  :   'Welkom to the Tutorials',      // string
            'fontSize'              :   '22px',                         // css
            'color'                 :   'silver',                       // css
        ...
        self.menuItems = {                                              // named array
            ...
            'helloWorld' : {                                            // named array
                ...
                'linkOptions' : {                                       // named array 
                    'url'           :   './pacMan_o_o/helloWorld/',     // string
                    'target'        :   '_self'                         // string
                }                                                       // done named array 
            },                                                          // done named array  
            'responsiveLayout' : {                                      // named array
                ...
                'linkOptions' : {                                       // named array 
                    'url'           :   './pacMan_o_o/responsiveLayout/', // string
                    'target'        :   '_self'                         // string
                }                                                       // done named array 
            },                                                          // done named array  
            'gameObjects' : {                                           // named array
                ...
                'linkOptions' : {                                       // named array 
                    'url'           :   './pacMan_o_o/gameObjects/',    // string
                    'target'        :   '_self'                         // string
                }                                                       // done named array 
            },                                                          // done named array  
            'animations' : {                                            // named array
                ...
                'linkOptions' : {                                       // named array 
                    'url'           :   './pacMan_o_o/animations/',     // string
                    'target'        :   '_self'                         // string
                }                                                       // done named array 
            },                                                          // done named array  
            'sound' : {                                                 // named array
