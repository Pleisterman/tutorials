...
( function( app ){
    ...
    app.pacManModule = function( ) {
        ...
        self.liveLost = function() {
        // FUNCTION: liveLost( void ) void
            
            // debug info
            self.debug( 'liveLost' );

        // DONE FUNCTION: liveLost( void ) void
        };
        self.nextLevel = function() {
        // FUNCTION: nextLevel( void ) void
            
            // debug info
            self.debug( 'nextLevel' );

        // DONE FUNCTION: nextLevel( void ) void
        };
