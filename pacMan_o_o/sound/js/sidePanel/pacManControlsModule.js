...
( function( app ){
    ...
    app.pacManControlsModule = function( parentId ) {
        ...
        // FUNCTION: addApplicationExtensions( void ) void
            ...
            // add enable pause play control
            app.enablePausePlayControl = self.enablePausePlayControl;
            
            // add disable pause play control
            app.disablePausePlayControl = self.disablePausePlayControl;
            
            // add show paused
            app.showPaused = self.showPaused;
            
            // add show playing
            app.showPlaying = self.showPlaying;
        ...
        self.enablePausePlayControl = function() {
        // FUNCTION: enablePausePlayControl( void ) void
            
            // enable pause play
            self.buttons['pausePlay']['enabled'] = true;
            
            // set cursor
            $( '#' + self.buttons['pausePlay']['id'] ).css( 'cursor', 'pointer' );
            
        // DONE FUNCTION: enablePausePlayControl( void ) void
        };
        self.disablePausePlayControl = function() {
        // FUNCTION: disablePausePlayControl( void ) void

            // disable pause play
            self.buttons['pausePlay']['enabled'] = false;
            
            // set cursor
            $( '#' + self.buttons['pausePlay']['id'] ).css( 'cursor', 'default' );
            
        // DONE FUNCTION: disablePausePlayControl( void ) void
        };
        self.showPlaying = function() {
        // FUNCTION: showPlaying( void ) void
            
            // set paused
            self.buttons['pausePlay']['isPlaying'] = true;

            // set image index
            let imageIndex = self.buttons['pausePlay']['imageIndexes']['play'];

            // set background position
            self.setBackgroundPosition( self.buttons['pausePlay']['id'], imageIndex );
            
        // DONE FUNCTION: showPlaying( void ) void
        };
        self.showPaused = function() {
        // FUNCTION: showPaused( void ) void
            
            // set paused
            self.buttons['pausePlay']['isPlaying'] = false;

            // set image index
            let imageIndex = self.buttons['pausePlay']['imageIndexes']['pause'];

            // set background position
            self.setBackgroundPosition( self.buttons['pausePlay']['id'], imageIndex );
            
        // DONE FUNCTION: showPaused( void ) void
        };
        ...
        // FUNCTION: pausePlayMouseOver( event: event, named array: buttonOptions ) void
            ...
            // ! enabled
            if( !self.buttons[buttonId]['enabled'] ){
        ...
        // FUNCTION: soundOnOffClick( event: event, named array: buttonOptions ) void
            ...
            // set is on
            self.buttons[buttonId]['isOn'] = !self.buttons[buttonId]['isOn'];
