/*
        ...
        file:       soundResourceModule.js
        function:   loads a sound resource
...
( function( app ){
    ...
    // MODULE: soundResourceModule( named array: options ) void 
    
    app.soundResourceModule = function( options ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                            // object
        self.MODULE = 'soundResourceModule';                        // string
        ...
        // FUNCTION: createResourceOptions( void ) void
            ...
            // copy options
            self.resourceOptions = jQuery.extend( true, {}, self.options );
        ...
        // FUNCTION: getSource( void ) void
            ...
            // loop over sources
            $.each( self.options['sources'], function( index, source ) {

                // no playable source and can play sound type
                if( playableSource === null &&
                    app.canPlaySoundType( index ) ){
            ...
            for( let i = 0; i < self.resourceOptions['audioObjects'].length; i++ ){
                ...
                if( audioObject['playing'] ){
                    ...
                    if( self.resourceOptions['canBePaused'] !== undefined &&
                        ...
                        // set paused volume
                        audioObject['pausedVolume'] = audioObject['audio'].volume;
        ...
        // FUNCTION: resume( void ) void
            ...
            for( let i = 0; i < self.resourceOptions['audioObjects'].length; i++ ){
                ...
                if( audioObject['isPaused'] === true ){
                    ...
                    // set volume
                    audioObject['audio'].volume = audioObject['pausedVolume'];
    ...
    // DONE MODULE: soundResourceModule( named array: options ) void
