...
<html lang='nl'>
    <head>
        ...
        <title>Pac Man Responsive Layout</title>
        ...
        <meta name="description" content="Javascript tutorials landing page: Pac Man Responsive Layout">
    ...
    <body>
        ...
        <script src="./js/pacManHeaderModule.js" charset="utf-8"></script>
        <script src="./js/pacManSidePanelModule.js" charset="utf-8"></script>
        <script src="./js/pacManBoardModule.js" charset="utf-8"></script>
